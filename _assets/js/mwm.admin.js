(function ($) {
    ...
    $.entwine('ss.tree', function ($) {
        ...
        // Remove the fa from the icon picker
        $('.icp--css-icon-shortcode').entwine({
            oniconpickerSetSourceValue:   function () {
                var $this = $(this);

                if($this.hasClass('icp--css-icon-shortcode') && $this.is(':input')) {
                    $this.val($this.val().replace('fa-', ''));
                }
            }
        });
    });
